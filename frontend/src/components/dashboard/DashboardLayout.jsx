                ...
                <header className="h-20 bg-white border-b border-black/5 flex items-center justify-between px-10 sticky top-0 z-40">
                    <div className="flex items-center bg-[#f3f4f6] px-4 py-2 rounded-none border border-black/5 w-96">
                        ...
                        <input
                            ...
                            className="bg-transparent border-none outline-none text-[11px] font-bold tracking-widest uppercase w-full placeholder:text-gray-300"
                        />
                    </div>
                    ...
                    <div className="flex items-center space-x-8">
                        <button className="relative text-gray-500 hover:text-black transition-colors">
                            <Bell size={20} />
                            <span className="absolute -top-1 -right-1 bg-black text-white text-[8px] w-4 h-4 flex items-center justify-center rounded-full border-2 border-white">3</span>
                        </button>
                        <div className="flex items-center space-x-4 border-l border-gray-100 pl-8">
                            <div className="text-right">
                                <p className="text-[11px] font-black uppercase tracking-widest text-black mb-0.5">{user?.name}</p>
